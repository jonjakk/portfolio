        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox"><label><input checked value="2" type="checkbox"/><?php esc_html_e( 'Total', 'bookly' ) ?></label></div>
                    ...
                    <div class="checkbox"><label><input checked value="7" type="checkbox"/><?php esc_html_e( 'Total', 'bookly' ) ?></label></div>
                    <div class="checkbox"><label><input checked value="8" type="checkbox"/><?php esc_html_e( 'New', 'bookly' ) ?></label></div>
                    <div class="checkbox"><label><input checked value="9" type="checkbox"/><?php esc_html_e( 'Revenue', 'bookly' ) ?></label></div>
                </div>
            </div>
